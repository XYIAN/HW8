/* TITLE Queue.cpp
 * ABSTRACT: Queue function definitions for Queue class which 
 * new ascending and descending functions which sort the queue
 * respectively to the given intergers
 * Author: Kyle Dilbeck 
 * ID: 1996
 * Date: 4/9/19
 */
